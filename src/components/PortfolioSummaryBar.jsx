function PortfolioSummaryBar({ value, passiveRate, changePct, onCmdToggle }) {
  return (
    <div className="fixed bottom-0 inset-x-0 bg-black/70 backdrop-blur-sm text-green-300 border-t border-green-700 flex justify-around items-center p-2 text-sm z-20">
